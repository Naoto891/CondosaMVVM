...
@Composable
fun FirmaDigitalSolicitanteScreen(
    idContrato: Int, firmaDigitalSolicitanteViewModel: FirmaDigitalSolicitanteViewModel, navController: NavHostController
) {
            ...
            Button(
                onClick = {
                    coroutineScope.launch{
                        ...
                        firmaDigitalSolicitanteViewModel.FirmarContratoSolicitante(idContrato, currentDate, signatureByteArray!!){
