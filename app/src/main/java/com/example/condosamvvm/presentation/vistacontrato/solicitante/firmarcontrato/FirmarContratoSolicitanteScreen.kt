...
@Composable
fun FirmarContratoSolicitanteScreen(idContrato: Int, navController: NavHostController){
    ...
    Column(
        ...
        Box(
            ...
            Text(text = "Bienvenido al contrato: $idContrato")
        }
        Row(
            ...
            Button(
                onClick = { navController.navigate(Screen.FirmaDigitalSolicitante.whitArgs(idContrato)) },
